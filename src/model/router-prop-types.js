// @see https://github.com/Javascript-Ninja/react-router-prop-types
...
// if specific params are expected, they should be specified per component
// otherwise, this is like PropTypes.any for match
export const anyMatch = PropTypes.shape({
